...
<template>
  <div class="flex w-8/12 items-center overflow-x-scroll no-scrollbar">
    ...
    <HomeServerItem v-for="(server, index) in servers" v-bind="server" :bgColor="serverList[index].bgColor" :key="index"
      :isSelected="index === selectedServer" :setSelectedServer="setSelectedServer" />
    <ModalServerCreate />
    <div
      ...
      <div :data-modal-target="ADD_SERVER_MODAL" :data-modal-toggle="ADD_SERVER_MODAL"
