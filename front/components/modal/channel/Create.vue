...
<template>
    <div :id="CREATE_CHANNEL_MODAL" tabindex="-1" aria-hidden="true"
                    ...
                    <form class="space-y-6" @submit.prevent="createChannel()">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nom du
                                channel</label>
                            <input v-model="channelName" type="text" id="email"
                        ...
                        <button @click="createChannel()" type="button"
                        ...
                        <button :data-modal-hide="CREATE_CHANNEL_MODAL" type="button"
