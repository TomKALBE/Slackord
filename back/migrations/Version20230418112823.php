...
final class Version20230418112823 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE channel (id INT NOT NULL, channel_group_id INT NOT NULL, name VARCHAR(255) NOT NULL, channelType VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE private_channel_user ADD CONSTRAINT FK_47BADD357F300BDD FOREIGN KEY (private_channel_id) REFERENCES channel (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE server_channel_user_role ADD CONSTRAINT FK_FAE79827A03A310D FOREIGN KEY (server_channel_id) REFERENCES channel (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
