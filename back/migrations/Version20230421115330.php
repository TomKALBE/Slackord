...
final class Version20230421115330 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abstract_channel (id INT NOT NULL, channel_group_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, channelType VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
