  ...
  <div class="h-screen w-screen flex flex-col">
    ...
    <div class="flex w-100 h-16 bg-slate-300">
      ...
      >
        ...
        >
          ...
          />
          <div
            class="w-3 h-3 absolute bg-orange-600 bottom-[-0.125rem] left-[-0.125rem] rounded-full"
          ></div>
        </div>
    ...
    <div class="flex-1 flex">
      ...
      >
        ...
        <!-- !SECTION -->
        <!-- SECTION Chat -->
        <div class="max-h-full flex flex-1">
          <div
            class="fixed flex-col-reverse chat-max-height overflow-scroll w-full ml-8"
          >
            <!-- SECTION Messages -->
            <!-- <div class="flex flex-col-reverse"> -->
            <!-- Todo Gérer l'overflow -->
            <div v-for="i in 25" :key="i" class="flex h-14">
